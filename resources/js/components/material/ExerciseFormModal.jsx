                ...
                <div className="mb-5 flex items-center justify-between gap-4">
                    <div>
                        ...
                        <h3 className="mt-2 text-xl font-black text-slate-900 dark:text-white">
                            {exercise ? 'Edit Latihan' : 'Tambah Latihan Baru'}
                        </h3>
                        <p className="mt-2 text-sm text-slate-500 dark:text-slate-400">
                            {activeChapter
                                ? `BAB aktif: ${activeChapter.title}`
                                : 'Pilih BAB terlebih dahulu untuk menambahkan latihan.'}
                        </p>
                    </div>
                    <button
                        type="button"
                ...
                <form className="space-y-5" onSubmit={handleSubmit}>
                    <label className="block">
                        ...
                        <textarea
                            ...
                            placeholder="Tuliskan pertanyaan latihan pilihan ganda..."
                        />
                    </label>
                    ...
                    <div className="flex justify-end gap-3 pt-2">
                        ...
                        >
                            {isSaving ? 'Menyimpan...' : exercise ? 'Update Latihan' : 'Simpan Latihan'}
                        </button>
                    </div>
                </form>
            </div>
